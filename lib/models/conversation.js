...
Conversation.getOrphan = function (id, actor, cbs) {
  API.get('/relationships?conversation_id=' + id, {
    success: function (r) {
      Conversation.get(r.id, id, {
        success: function (c) {
          c.actor = actor;
          cbs.success(c);
        },
  ...
  if (this.relationship) {
    ...
    API.get('/relationships/' + this.relationshipId, {
      success: function (relationship) {
        self.relationship = Relationship.fromObject(relationship, self.actor);
